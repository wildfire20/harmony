...
const EnrollmentSection = () => {
  ...
  const grades = [
    { value: "preschool-0", label: "Preschool (Age 0)" },
    { value: "preschool-1", label: "Preschool (Age 1)" },
    { value: "preschool-2", label: "Preschool (Age 2)" },
    { value: "preschool-3", label: "Preschool (Age 3)" },
    { value: "preschool-4", label: "Preschool (Age 4)" },
    { value: "preschool-5", label: "Preschool (Age 5)" },
    { value: "preschool-6", label: "Preschool (Age 6)" },
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-400">
              <li className="flex items-start gap-3">
                ...
                <span>2 Skilferdoring Street<br />Onverwacht, Lephalale</span>
              </li>
              <li className="flex items-center gap-3">
                ...
                <a href="https://wa.me/27711679620" target="_blank" rel="noopener noreferrer" className="hover:text-green-400 transition-colors">071 167 9620 (WhatsApp)</a>
              </li>
              <li className="flex items-center gap-3">
                <svg className="w-5 h-5 text-red-600 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                </svg>
                <span>014 763 1358</span>
              </li>
              <li className="flex items-center gap-3">
                <svg className="w-5 h-5 text-red-600 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <a href="mailto:harmonylearninginstitute@gmail.com" className="hover:text-white transition-colors">harmonylearninginstitute@gmail.com</a>
              </li>
            </ul>
          </div>
        </div>
            ...
            <div className="flex items-center gap-6">
              ...
              >
                ...
                <div className="text-gray-400 text-xs">
                  ...
                  <span className="text-blue-400 font-medium group-hover:text-blue-300 transition-colors">AutoM8</span>
                </div>
              </a>
            </div>
          </div>
...
const WhatsAppButton = () => {
  return (
    <a
      href="https://wa.me/27711679620"
      target="_blank"
      rel="noopener noreferrer"
      className="fixed bottom-6 right-6 z-50 w-14 h-14 bg-green-500 rounded-full shadow-lg hover:bg-green-600 transition-all duration-300 flex items-center justify-center hover:scale-110 group"
