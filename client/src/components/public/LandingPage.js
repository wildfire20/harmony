        ...
        <div className="flex items-center justify-between h-16 md:h-20">
          <a href="/" className="flex items-center gap-3">
            ...
            <div>
              ...
              <span className="block text-xs text-orange-600 font-medium">Institute</span>
            </div>
          </a>

          <nav className="hidden md:flex items-center gap-8">
            <a href="#about" className="text-sm font-medium text-gray-700 hover:text-orange-600 transition-colors">About</a>
            <a href="#gallery" className="text-sm font-medium text-gray-700 hover:text-orange-600 transition-colors">Gallery</a>
            <a href="#programs" className="text-sm font-medium text-gray-700 hover:text-orange-600 transition-colors">Programs</a>
            <a href="#enroll" className="text-sm font-medium text-gray-700 hover:text-orange-600 transition-colors">Enroll</a>
          </nav>
          ...
          <div className="flex items-center gap-3">
            ...
            <a href="#enroll" className="hidden sm:inline-flex px-5 py-2.5 text-sm font-medium text-white bg-gradient-to-r from-orange-500 to-yellow-500 rounded-lg hover:from-orange-600 hover:to-yellow-600 transition-all shadow-lg hover:shadow-xl">
              Apply Now
            </a>
            <button
        ...
        {mobileMenuOpen && (
          <div className="md:hidden py-4 border-t border-orange-100 bg-white">
            <nav className="flex flex-col gap-2">
              <a href="#about" className="px-4 py-3 text-sm font-medium text-gray-700 hover:bg-orange-50 hover:text-orange-600 rounded-lg" onClick={() => setMobileMenuOpen(false)}>About</a>
              <a href="#gallery" className="px-4 py-3 text-sm font-medium text-gray-700 hover:bg-orange-50 hover:text-orange-600 rounded-lg" onClick={() => setMobileMenuOpen(false)}>Gallery</a>
              <a href="#programs" className="px-4 py-3 text-sm font-medium text-gray-700 hover:bg-orange-50 hover:text-orange-600 rounded-lg" onClick={() => setMobileMenuOpen(false)}>Programs</a>
              <a href="#enroll" className="px-4 py-3 text-sm font-medium text-gray-700 hover:bg-orange-50 hover:text-orange-600 rounded-lg" onClick={() => setMobileMenuOpen(false)}>Enroll</a>
              <div className="flex gap-2 px-4 pt-3">
                ...
                <a href="#enroll" className="flex-1 py-3 text-sm font-medium text-center text-white bg-gradient-to-r from-orange-500 to-yellow-500 rounded-lg">Apply Now</a>
              </div>
            </nav>
          </div>
        )}
    ...
    <section className="relative min-h-screen pt-16 md:pt-20">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 min-h-screen flex items-center">
        <div className="max-w-2xl py-20">
          <span className="inline-flex items-center gap-2 mb-6 px-4 py-2 text-sm font-semibold bg-orange-500 text-white rounded-full shadow-lg">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <a href="#enroll" className="px-8 py-4 text-lg font-semibold text-gray-900 bg-gradient-to-r from-yellow-400 to-orange-400 rounded-xl hover:from-yellow-500 hover:to-orange-500 transition-all shadow-xl hover:shadow-2xl flex items-center justify-center gap-2">
              Enroll Your Child
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-2 gap-12 lg:gap-20 items-center">
          <div className="relative">
            ...
            <div className="absolute -bottom-6 -right-6 bg-gradient-to-br from-orange-500 to-yellow-500 rounded-2xl p-6 shadow-xl text-white hidden md:block">
          ...
          <div>
            <span className="inline-block px-4 py-1.5 bg-orange-100 text-orange-700 rounded-full text-sm font-semibold mb-4">About Us</span>
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 mb-6">
              An Exceptional School Where Every Learner <span className="text-orange-500">Thrives</span>
            </h2>
...
const GallerySection = () => {
  ...
  return (
    <section id="gallery" className="py-20 md:py-32 bg-gradient-to-b from-orange-50 to-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <span className="inline-block px-4 py-1.5 bg-orange-100 text-orange-700 rounded-full text-sm font-semibold mb-4">Life at Harmony</span>
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 mb-4">
            Experience Our <span className="text-orange-500">Vibrant</span> School Life
          </h2>
...
const ProgramsSection = () => {
  ...
  return (
    <section id="programs" className="py-20 md:py-32 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <span className="inline-block px-4 py-1.5 bg-orange-100 text-orange-700 rounded-full text-sm font-semibold mb-4">Our Programs</span>
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 mb-4">
            Programs Designed for <span className="text-orange-500">Success</span>
          </h2>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
...
const EnrollmentSection = () => {
  ...
  if (submitted) {
    return (
      <section id="enroll" className="py-20 md:py-32 bg-gradient-to-b from-orange-50 to-yellow-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-2xl shadow-2xl p-12 text-center">
            ...
            <button 
              ...
              className="px-8 py-4 bg-gradient-to-r from-orange-500 to-yellow-500 text-white font-semibold rounded-xl hover:from-orange-600 hover:to-yellow-600 transition-all shadow-lg"
            >
    ...
    <section id="enroll" className="py-20 md:py-32 bg-gradient-to-b from-orange-50 to-yellow-50">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          <div>
            <span className="inline-block px-4 py-1.5 bg-orange-100 text-orange-700 rounded-full text-sm font-semibold mb-4">Enroll Now</span>
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 mb-6">
              Ready to Join Our <span className="text-orange-500">Family?</span>
            </h2>
          ...
          <div className="bg-white rounded-2xl shadow-2xl p-8">
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full py-4 px-6 bg-gradient-to-r from-orange-500 to-yellow-500 text-white font-bold text-lg rounded-xl hover:from-orange-600 hover:to-yellow-600 transition-all shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
              >
                {loading ? (
                  <>
        ...
        <div className="grid md:grid-cols-4 gap-12">
          <div className="md:col-span-2">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                <span className="font-bold text-xl">Harmony Learning</span>
                <span className="block text-sm text-orange-400">Institute</span>
              </div>
            </div>
